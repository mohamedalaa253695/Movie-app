    ...
    <div class="popular-moveies">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="mt-8">
              ...
              <a href="#">
                    <img src="/img/parasite.jpg" alt="parasie" class="hover:opacity-75 transition ease-in-out duration-150">    
             </a>   
             <div class="mt-2">
             ...
             <div class="tex-gray-400 text-sm">
            ...
            <div class="mt-8">
                ...
                <a href="#">
                      <img src="/img/joker.jpg" alt="parasie" class="hover:opacity-75 transition ease-in-out duration-150">    
               </a>   
               <div class="mt-2">
              ...
              <div class="mt-8">
                ...
                <a href="#">
                      <img src="/img/frozen2.jpg" alt="parasie" class="hover:opacity-75 transition ease-in-out duration-150">    
               </a>   
               <div class="mt-2">
              ...
              <div class="mt-8">
                ...
                <a href="#">
                      <img src="/img/sonic.jpg" alt="parasie" class="hover:opacity-75 transition ease-in-out duration-150">    
               </a>   
               <div class="mt-2">
